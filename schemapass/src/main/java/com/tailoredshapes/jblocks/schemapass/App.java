...
public class App {
    ...
    public App(int port, Schema schema, String prefix, String next) {
        service = ignite();
        service.port(port);

        var handler = new ValidatationHandler(schema, next);
    ...
    public static void main(String[] args) {
        ...
        var schemaJson = new JSONObject(slurp(new File(uri)));
